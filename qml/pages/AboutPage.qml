    ...
    Flickable {
        ...
        Column{
            ...
            Button {
                id: homepage
                anchors.horizontalCenter: parent.horizontalCenter
                text: "<a href=\"https://github.com/llelectronics/turboReadR\">Sourcecode on Github</a>"
                onClicked: {
                    Qt.openUrlExternally("https://github.com/llelectronics/turboReadR")
                }
            }
            ...
            Label {
                ...
                font.pixelSize: Theme.fontSizeSmall
                text: qsTr("A simple reading application.")
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignHCenter
                height: 200
